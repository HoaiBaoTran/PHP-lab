<DOCTYPE html>
    ...
    <body>
        ...
        if (isset($_SESSION['email-reset-password'])) {
            $email_reset = $_SESSION['email-reset-password'];
        }
        ...
        if (
            ...
            if (empty($email)) {
                ...
                try {
                    ...
                    $stmt->execute(array($password_hash, $email));  
                ...
                <div class="col-md-6 col-lg-5">
                    ...
                    <form novalidate method="post" action="" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                        <div class="form-group">
                            ...
                            <input readonly value="<?= $email_reset ?>" name="email" id="email" type="text" class="form-control" placeholder="Email address">
                        </div>
                        <div class="form-group">
